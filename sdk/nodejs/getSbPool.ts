...
export interface GetSbPoolResult {
    ...
    /**
     * (Computed) (Block Set) List of nested blocks describing the information of backup records for the SiteBacker pool. Specifies the records to be served if all other records fail. There can be one or more A records used as backup records, or a single CNAME record. The structure of this block is described below.
     */
    ...
    readonly id: string;
    /**
     * (Computed) (Integer) Specifies the maximum number of active servers in a pool and determines when SiteBacker takes backup servers offline.<br/>
    ...
    /**
     * (Computed) (Integer) Determines the number of record answers for each query. This is typically All Active records, or a subset of Max Active.
     */
    readonly maxServed: number;
    /**
     * (Computed) (String) Indicates the order of the records returned by the resolver for the SiteBacker pool.
     */
    readonly order: string;
    readonly ownerName: string;
    /**
     * (Computed) (String) An optional description of the SiteBacker (SB) field.
     */
...
export function getSbPoolOutput(args: GetSbPoolOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSbPoolResult> {
    return pulumi.output(args).apply(a => getSbPool(a, opts))
}
